...
import me.north.easybase.api.clickgui.ADragComponent;
...
public class Frame extends ADragComponent {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(category.name, x + 2f, y + 2.5f, new Color(255, 255, 255).getRGB());
        int yOffset = height;
