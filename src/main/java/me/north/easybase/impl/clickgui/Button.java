...
import me.north.easybase.api.clickgui.AToggleContainer;
...
public class Button extends AToggleContainer {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
    	...
    	int toggleColor = module.isToggled() ? new Color(50, 80, 255, 200).getRGB() : new Color(40, 40, 40, 200).getRGB();
    	
    	Gui.drawRect(x, y, x + width, y + height, toggleColor);

        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(module.getName(), x + 2f, y + 2.5f, new Color(255, 255, 255).getRGB());
    }
